...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "exec Grade_Short_Answer " + testId + ", " + studentId;
    ...
    {        
        ...
        try
        {
            ...
            if (points <= Convert.ToInt32(GridView1.Rows[e.RowIndex].Cells[5].Text))
            {
                errmsg.Text = string.Empty;
            }
            else
            {
                errmsg.Text = "Points given should not be higher than the maximum of " + GridView1.Rows[e.RowIndex].Cells[5].Text + "!!!";
                errmsg.Visible = true;
            }
        }
        ...
        if (errmsg.Visible == false)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("Update_Short_Answer_Grade"))
                {
    ...
    protected void publishGradeButton_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("ShortAnswerGrade.aspx");
    }
}