<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EssayGrade.aspx.cs" Inherits="EssayGrade" %>
      ...
      <div class="row">
         <div class="card card-nav-tabs">
           <div class="card-header card-header" style="background:#00bcd4;">
             <h1 class="card-subtitle mb-2 text-muted"><asp:Label ID="courseNumber" ForeColor ="white" runat="server">Essay Grading</asp:Label></h1> <!-- Replace with whatever class name was clicked -->
         </div>
         ...
         <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CS414_VirtualExamConnectionString %>" SelectCommand="View_Students_With_Finished_Tests_EQ" SelectCommandType="StoredProcedure" >
                        <SelectParameters>
